jQuery(document).ready(function ($) {
	...
	$(document).keydown(function(event){
		...
		var myslide = $(".current").attr("data-slide");
		if(40 == event.keyCode){//+1
			dataslide = parseInt(myslide)+1 == 5 ? 1 : parseInt(myslide)+1;
		}else if(38 == event.keyCode){
			dataslide = parseInt(myslide)-1 == 0 ? 4 : parseInt(myslide)-1;
		}
		goToByScroll(dataslide);
	});
});